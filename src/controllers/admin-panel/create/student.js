...
const createStudent = async (req, res) => {
    ...
    // await generateBcrypt();
    const student = await Student.create({ studentId, name, mobile, email, picture: fileName + extension, courseId, semesterId, createdBy: tokenData.id, status: 0 })
